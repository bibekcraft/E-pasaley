...
from app.views import OrderCreateView
...
urlpatterns = [
    ...
    path('orders/', OrderCreateView.as_view(), name='order-create'),    path('orders/<int:pk>/', OrderDetailAPIView.as_view(), name='order-detail'),
